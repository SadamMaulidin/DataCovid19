...
class DetailCountryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        country_name.text = tNegara
        total_death_currently.text = tDeath
        new_death_currently.text = tnDeath
        new_confirmed_currently.text = tnConfirmed
        new_recovery_currently.text = tnRecovered
        total_confirmed_currently.text = tConfirmed
        total_recovery_currently.text = tRecovered
        ...
        api.getInfoService(tNegara!!).enqueue(object  : Callback<List<InfoNegara>> {
            ...
            override fun onResponse(call: Call<List<InfoNegara>>, response: Response<List<InfoNegara>>) {
                if (response.isSuccessful){
                    ...
                    // uhmengatur keseluran view barchart
                    data.barWidth = 0.15f
